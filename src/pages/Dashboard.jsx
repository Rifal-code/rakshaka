...
export const Dashboard = () => {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      console.error(err);
      setError('Gagal memuat daftar laporan. Pastikan koneksi internet atau server aktif.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <DashboardLayout>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="glass-panel p-5 border-orange-500/10 relative overflow-hidden">
          ...
          <span className="text-xs font-mono text-slate-500 uppercase tracking-widest">Laporan Scam</span>
          <h3 className="text-3xl font-display font-extrabold text-orange-400 mt-2">{stats.scam}</h3>
          <p className="text-[10px] text-slate-400 mt-1">Investasi/toko fiktif</p>
        </div>
        ...
        <div className="glass-panel p-5 border-cyber-cyan/10 relative overflow-hidden">
          ...
          <span className="text-xs font-mono text-slate-500 uppercase tracking-widest">Laporan Phishing</span>
          <h3 className="text-3xl font-display font-extrabold text-cyber-cyan mt-2">{stats.phishing}</h3>
          <p className="text-[10px] text-slate-400 mt-1">Duplikasi bank/web login</p>
        </div>
      ...
      {loading ? (
        <div className="h-[300px] border border-cyber-border rounded-2xl bg-cyber-card/30 flex flex-col items-center justify-center">
          ...
          <p className="text-sm font-mono text-slate-500 uppercase tracking-widest">Mengunduh Dokumen Laporan...</p>
        </div>
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredReports.map((report) => {
              ...
              const firstImage = report.images && report.images.length > 0 
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-cyber-border/60">
                      <span className="text-[10px] font-mono text-slate-500 truncate max-w-[120px]" title={report.id}>
